...
.center button {
 ...
 <form method="POST" action="newNhanVienServlet" enctype="multipart/form-data">
 <table>
 <tr>
 <td style="color:white">Mã nhân viên</td>
 <td><input type="text" name="Id"/></td>
 </tr>
 <tr>
 <td style="color:white">Tên nhân viên</td>
 ...
 <td colspan="2"><a href = NhanVienListServlet><center><button>Thêm</button></td></a>
 </tr>
 </table>
	       </center>
           </center> 
