...
<html lang="en">
  ...
  <body>
    ...
    <% if (request.getAttribute("username") != null) { %>
        <h4><%= request.getAttribute("username") %></h4>
    <% } %>
    <p class="mb-0" <% if (request.getAttribute("username") != null) { %>style="display: none"<% } %>>
        
        <a href="LogIn.jsp" style="color:white">Đăng nhập</a>
    </p>
</div>
...
.center button {
 ...
 <tr>
 <td style="color:white">Giới tính</td>
 ...
 <tr>
 <td colspan="2"><a href = "Success.jsp"><center><button>Đăng ký</button></td></center></a>
 </tr>
 </table>
 </form>
 <div>
