...
.center button {
 ...
 <table>
 <tr>
 <td style="color:white">Mã sản phẩm</td>
 ...
 <tr>
 <td style="color:white">Loại sản phẩm</td>
 <td><input type="text" name="type"/></td>
 </tr>
 <tr>
 <td style="color:white">Giá sản phẩm</td>
 <td><input type="text" name="price"/></td>
 </tr>
 <td style="color:white">Hình sản phẩm</td>
 <td><input type="text" name="image"/></td>
 </tr>
 <center>
 <tr>
 <td colspan="2"><a href = ProductListServlet><button>Thêm</button></td></a>
 </tr>
 </center>
 </table>
 </form>
